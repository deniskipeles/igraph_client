...
let password = '';
 ...
 const signUp = async () => {
   let { data: user, error } = await supabaseClient.auth.signUp({
     email,
     password
   })
   if(user){
...
<div class="container">
  <form on:submit|preventDefault={signUp}>
    <div class="row">
      <h2 style="text-align:center">Sign up with Social Media or Email</h2>
      <div class="vl">
...
<div class="bottom-container">
  <div class="row">
    ...
    <div class="col">
      <a href="/reset-password" style="color:white" class="btn">Forgot password?</a>
    </div>
  </div>
</div>
